...
@AllArgsConstructor
@Builder
@Schema(description = "독서장 작성 요청")
public class ReadingNoteCreateRequest {
    ...
    @Schema(description = "기억에 남는 문구 (독서장 내용)",
            example = "아무리 노력해도 회복할 수 없는 것이 있고, 아무리 노력해도 손에 넣을 수 없는 것이 있다.")
